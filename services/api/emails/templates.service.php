<?php
	//platform templates to send emails

  //support course not delivery, sended to the platform support
          ...
          <!DOCTYPE HTML PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
            ...
            * {
            ...
            <table style="font-family:georgia,palatino;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
              ...
              <div style="color: #3d3030; line-height: 140%; text-align: center;">
                <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 16px; line-height: 22.4px; font-family: Arial, Helvetica, sans-serif;"><span style="line-height: 22.4px; font-size: 16px;">Un usuario se ha puesto en contacto usando la página web, te mostramos los detalles del usuario para que puedas ponerte en contacto con el:</span></span></p>

                <table style="width: 100%; margin-top:15px; margin-bottom: 15px; text-align: left;">
                  <tr>
